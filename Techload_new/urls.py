...
urlpatterns = [
    ...
    path('password-reset-confirm/done',auth_views.PasswordResetCompleteView.as_view(template_name='reset/password_reset_compelete.html'),name='password_reset_compelete'), #new
]
